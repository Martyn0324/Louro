#Louro, the Parrot Bot. Created as a way of practicing Natural Language Processing, Machine Learning and chatbot development

#Development tree:
#1° - Dice bot, plain and simple.
#Bônus - Mini-games: Duel between guild members + Text Adventure
#2° - Smalltalk and superficial talk. ELIZA Parrot
#3° - More complex Natural Language Processing --> Ability to talk with users
#4° - Personality creation and more talk capability --> Virtual Assistant
...
#Testing how to send images and files to discord using bot
@client.command()
async def image(ctx):
    await ctx.send(file=discord.File('C:/Program Files (x86)/Steam/Músicas/tenor.gif'))

@client.command()
async def music(ctx):
    await ctx.send(file=discord.File('C:/Games/Ragnarok/BGM/04.mp3'))

@client.command()
async def video(ctx):
    await ctx.send("https://www.youtube.com/watch?v=fs3V7UPqDp0")
...
#Error code --> Should appear when someone mispells one command
@client.listen()
async def on_error(error):
    erro = 'Crááaa? I dont get it, Crááá! Try Louro, help'
    await ctx.send(erro)

#First utility command we're gonna use
@client.command()
async def d6(ctx):
    d6 = ['1', '2', '3', '4', '5', '6']
...
async def d20(ctx):
    ...
    x = random.choice(d20)
    if x == '20':
            response = 'Cráááá! **20**! **20**! Cráááá! Make it count! Make it count!'
            await ctx.send(response)
    if x == '1':
            response = '**1**! **1**! Bad luck! Bad luck! Crááá!'
            await ctx.send(response)
    if x == '2':
            response = "Cráááá! **2**! **2**! At least isn't 1! Crááá!"
            await ctx.send(response)
    if x == '3' or x == '4' or x == '5' or x == '6':
            response = "Cráááá! **" + x + '**! **' + x + '**! ' + "Bad number! Bad number! Cráááá!"
            await ctx.send(response)
    if x == '16' or x == '17' or x == '18':
            response = "Cráááá! **" + x + '**!**' + x + '**!' + " Good one! Is it enough, though? Crááá!"
            await ctx.send(response)
    if x == '19':
            response = "Cráááá! **19**! **19**! Good one! Good one! But not lucky enough to get 20! Crááá!"
            await ctx.send(response)
    elif x == '7' or x == '8' or x == '9' or x == '10' or x == '11' or x == '12' or x == '13' or x == '14' or x == '15':
            response = "Cráááá! **" + x + '**! **' + x + '**!' + " Crááá! Boring! Boring! Crááá!"
            await ctx.send(response)
...
async def mystic(ctx):
    mm = ['https://media1.tenor.com/images/b2026cf4459a50aa1ad17e715b1ad569/tenor.gif?itemid=18197332',
          'https://media1.tenor.com/images/56b558741148e22ad2dec2f77d6103a0/tenor.gif?itemid=17904621',
          'https://media1.tenor.com/images/78f866d270359ada789de938578a966a/tenor.gif?itemid=17590897',
          'https://media1.tenor.com/images/f1f61daeb11ff6ceaefb01692b3f00b8/tenor.gif?itemid=18146810',
          'https://media1.tenor.com/images/96cc19125fa170f30e65253ae847cea6/tenor.gif?itemid=18070386']
    await ctx.send(random.choice(mm))


gladius_initiative = {2: "You charge against your enemy with your shield protecting you. However, you can't see where you are going as your scutum is blocking your vision. Your opponent takes a step to the side and kicks your leg, making you fall on the ground",
                      3: "You're too afraid of charging against your enemy and fighting hand-to-hand, so you just throw your gladius against your opponent. Unfortunately, the gladius couldn't even reach your opponent and now you're disarmed",
                      4: "You charge against your enemy with your scutum protecting you. When you get close enough, you try to hit your opponent with your shield",
                      5: "You charge against your enemy with your scutum protecting you. When you get close enough, you try to thrust your sword against your opponent",
                      6: "You scream and charge furiously against your opponent. Nothing can stop you. **NOTHING!**"}
...
#Emojis and IDs: <:yay:786937795297673236> <:screaming:768835859394723881> <:wtf:768834966695444550> <:shocked:768832734625267743> 
#<:scared:786937750372876288> <:saywhat:768835998037573702> <:happy:768836056245731359> <:gunparrot:769189863890485289> 
#<:fabulous:786937705338372126> <:badass:768835911685242930> 
...
@client.listen()
async def on_message(message):
    if 'good evening' in message.content.lower() or 'good afternoon' in message.content.lower():
        await message.channel.send("Cráááááá! Heya! Heya! Crááááá!")
